...
public class QuestionViewFloat extends IQuestionView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        editText=view.findViewById(R.id.view_float_value);
        return view;
    }

    @Override
    public IValue getSelectedItem() {
        return new ValueFloat(Float.parseFloat(editText.getText().toString()));
    }
